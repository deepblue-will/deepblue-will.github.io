(function() {
  $(function() {
    var msgAry;
    msgAry = ["ﾀﾞｯｼｭ!≡≡≡ﾍ(*--)ﾉ", "(((((((/_)/ ﾋｨｨｲｲｰ!!", "(((((･_･)", "((((((^_^)ﾆｹﾞﾖｯ", "εε= κ( ` ▽´)κｹｹｹ"];
    return $(".uzai-btn").on('mouseenter', function() {
      var btnGroup, clRndLeft, cloneGroup, cloneMsg, msgBox, rndBottom, rndClone, rndLeft, rndMsg;
      ...
      if (rndClone === 0) {
        ...
        return $("#container").append(cloneGroup);
      }
    });
  });
